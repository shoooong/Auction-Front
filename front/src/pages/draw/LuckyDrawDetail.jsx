    ...
    useEffect(() => {
        if (luckyDraw) {
            ...
            const updateRemainingTime = () => {
                ...
                if (timeDiff <= 0) {
                    setRemainingTime(
                        "00<span class='colon'>:</span>00<span class='colon'>:</span>00<span class='colon'>:</span>00"
                    );
                } else {
                    const days = String(
    ...
    return (
        <div className="container">
            ...
            <div className="cautions">
                ...
                <ul>
                    <li>
                        본 이벤트는 PUSH 7월 신규회원 대상 앱 전용 이벤트입니다.
                        (24년 7월 1일 이후 가입 회원 대상)
                    </li>
                    <li>
                        광고성 정보 수신 설정(앱푸시, 문자, 메일)에 모두
                        동의해야 응모 참여 가능합니다.
                    </li>
                    <li>
                        응모 이벤트 참여 완료는 마이페이지 응모내역에서 확인
                        가능합니다.
                    </li>
                    <li>
                        당첨자에 한하여 거래 체결 관련 개별 메시지를 발송
                        드리며, 미당첨자에게는 별도의 연락을 드리지 않습니다.
                    </li>
                    <li>
                        당첨자에게 서류 요청 후, 72시간 내에 회신이 없으면
                        당첨이 자동 취소되며, 재추첨은 진행되지 않습니다.
                    </li>
                    <li>
                        제세공과금은 PUSH에서 부담하며, 제세공과금 처리를 위해
                        가입하신 이메일 주소로 신분증 등 서류를 요청드립니다.
                    </li>
                    <li>
                        회원정보가 일치하지 않거나 부당한 방법으로 응모한 고객의
                        경우 당첨이 자동 취소되며, 및 추후 이벤트 응모 시
                        불이익을 받을 수 있습니다.
                    </li>
                    <li>
                        경품은 랜덤으로 지급되며, 교환 및 환불이 불가능합니다.
                    </li>
                    <li>
                        일부 제품은 출시 연기 및 수급 상황에 따라 배송이 늦어질
                        수 있습니다.
                    </li>
                </ul>
            </div>
