        ...
        const fetchProducts = async () => {
            try {
                const response = await axios.get(
                    `${SERVER_URL}/products/${category}/all_product_NewBuyingBid`
                );
        ...
        <div className="container">
            <Box className="box">
                <Box className="product-title-box">
                    <h2 className="product-title">New Lowest Bid</h2>
                    <h3 className="product-sub-title">새로운 즉시 구매가</h3>
                </Box>
